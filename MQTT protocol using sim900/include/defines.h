...
#define SECRET_GPRS_APN      "www.mobitel.lk" // replace your GPRS APN
#define SECRET_GPRS_LOGIN    "AkalankaShani"    // replace with your GPRS login
#define SECRET_GPRS_PASSWORD "aio_eNnE58KWFeyE1erpxwvPht3jxheC" // replace with your GPRS password
